...
class TestRook(unittest.TestCase):
    # Metodo de ayuda para probar el movimiento de Rook
    def test_rook_movimiento(self, x1, y1, x2, y2, resultado_esperado):
    ...
    def test_movimiento_valido_horizontal(self):
        self.test_rook_movimiento(0, 0, 0, 3, True) # Movimiento Horizontal       
    
    def test_movimiento_valido_vertical(self):
        self.test_rook_movimiento(0, 0, 3, 0, True) # Movimiento Vertical

    def test_movimiento_incorrecto_diagonal(self):
        self.test_rook_movimiento(0, 0, 3, 3, False) # Movimiento Diagonal
    
    def test_movimiento_incorrecto_no_recto(self):
        self.test_rook_movimiento(0, 0, 2, 2, False) # Movimiento no recto
